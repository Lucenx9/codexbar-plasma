...
| --- | --- | --- |
| Plasma baseline | [`a30e4ea8ed37de4e9e63438876998abca7cfb8a5`](https://github.com/Lucenx9/codexbar-plasma/commit/a30e4ea8ed37de4e9e63438876998abca7cfb8a5) | 2026-08-20 |
...
| 0.53.0 | Explicit cost provenance/coverage, hourly activity, 365-day inputs, custom pricing, OpenCodex import | Coverage/provenance is a correctness gap. Longer daily ranges need a bounded frontend design; hourly activity remains blocked without an official JSON field. OpenCodex import remains CLI-owned. |
...
| Longer daily spend ranges | 0.53.0 introduced 365-day inputs | The JSON daily contract supports longer bounded ranges now. |
...
| Hourly spend/activity views | The official cost JSON has daily rows but no hourly field. Do not infer hours from dates. |
