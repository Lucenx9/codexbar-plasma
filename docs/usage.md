...
- Global **Usage & Spend** tab with a Cost/Tokens selector, a 7/30/90-day range
  ...
  rows and week columns, leaving empty cells for unavailable days between
  measurements. Measured zero remains a recorded day. It stays hidden for
  ranges that fill a single column.
