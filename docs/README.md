...
- [0.66.0 release review](research/2026-09-25-macos-parity-0.66.0.md): the
  ...
  fixture, the #3944 plugin-entry preservation in CLI config writes, and
  checksum-verified official CLI probes. Provider descriptors, generic config
