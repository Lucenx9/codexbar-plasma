...
require_in_surface providers "var fieldTitle = SafeText.cliMessage(raw.title, 120)"
require_in_surface providers "description: SafeText.cliMessage(raw.description, 500)"
require_in_surface providers "var optionTitle = SafeText.cliMessage(option.title, 120)"
require_in_surface providers "title: optionTitle.length > 0 ? optionTitle : optionID"
