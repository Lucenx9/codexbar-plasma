...
require_in_file "$UPDATER" "kpackagetool6 -t Plasma/Applet \"\$INSTALL_OPTION\""
...
# Restart consent and isolation from updater modes are exercised in test_release_setup.py.
