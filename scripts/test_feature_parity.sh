...
require_in_file "$PROVIDERS_QML" "function handleDescriptorFieldResult(descriptor, stdoutText, stderrText)"
require_in_file "$PROVIDERS_QML" "function handleDescriptorActionResult(descriptor, stdoutText, stderrText)"
...
require_in_file "$GENERAL_QML" "cfg_widgetUpdateLastError"
require_in_file "$GENERAL_QML" "String(cfg_widgetUpdateLastError || \"\").slice(0, 500)"
