...
require_in_file "$MAIN_QML" "model: tokenCostSection.cachedCostBreakdownRows"
require_in_file "$MAIN_QML" "model: tokenCostSection.cachedCostModelRows"
require_in_file "$MAIN_QML" "model: tokenCostSection.cachedCostDailyRows"
require_in_file "$MAIN_QML" "model: root.costHistoryRows(tokenCostSection.tokenCost)"
