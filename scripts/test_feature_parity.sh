...
require_in_file "$MAIN_QML" "model: root.costBreakdownRows(tokenCost)"
require_in_file "$MAIN_QML" "model: root.costModelRows(tokenCost)"
require_in_file "$MAIN_QML" "model: root.costDailyRows(tokenCost)"
require_in_file "$MAIN_QML" "model: root.costHistoryRows(tokenCost)"
