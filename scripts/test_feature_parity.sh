...
require_in_surface applet "models: Normalizer.normalizeCostModels(item.daily, currency, historyDays, item.updatedAt)"
...
require_in_file "$DISPLAY_QML" "value: PanelDisplay.runOutMode"
...
require_in_file "$DISPLAY_QML" "Panel text:"
require_in_file "$DISPLAY_QML" "Show provider name in panel"
require_in_file "$DISPLAY_QML" "Show usage text in panel"
require_in_file "$DISPLAY_QML" "enabled: showPercentCheck.checked"
require_in_file "$DISPLAY_QML" "Show usage as percent used"
require_in_file "$DISPLAY_QML" "Show quota warnings on usage meters"
require_in_file "$DISPLAY_QML" "Show reset times as clock time"
require_in_file "$DISPLAY_QML" "Show multi-provider meters in panel"
