...
QtObject {
    ...
    function titleForKey(key, privateFallback) {
        var names = {
            ...
            "devin": i18n("Devin"),
            "devpass": i18n("DevPass"),
            "doubao": i18n("Doubao"),
            "elevenlabs": i18n("ElevenLabs"),
            "factory": i18n("Droid"),
            "fireworks": i18n("Fireworks"),
            "gemini": i18n("Gemini"),
            "gitkraken": i18n("GitKraken AI"),
            "grok": i18n("Grok"),
            "groq": i18n("Groq"),
            "helmcode": i18n("Helmcode"),
            "huggingface": i18n("Hugging Face"),
            "hyper": i18n("Charm Hyper"),
            "ibmbob": i18n("IBM Bob"),
            ...
            "t3chat": i18n("T3 Chat"),
            "typesafe": i18n("TypeSafe"),
            "v0": i18n("v0"),
            "venice": i18n("Venice"),
            "vercel": i18n("Vercel AI Gateway"),
